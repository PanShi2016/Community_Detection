function [] = MOV() 
% A locally-biased version of the Fiedler vector
...
% detect community by MOV algorithm
[set,conductance] = MOVgrow(graph,seed);
...
% save out result
savePathandName = '../../Results/zachary/result_MOV.txt';
