function [] = cond_mat_2005()
% Process cond-mat-2005 dataset

dataPath = '../Original_Data/cond-mat-2005/';
savePath = '../Processed_Data/';

% load cond-mat-2005.gml
edges = importdata([dataPath,'cond-mat-2005.gml'],'');
...
dlmwrite([savePath,'cond-mat-2005'],newedges,'precision',10,'delimiter','\t');
